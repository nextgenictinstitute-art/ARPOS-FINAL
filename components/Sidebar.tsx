...
import { LayoutDashboard, ShoppingCart, Package, Truck, BarChart3, Bot, Printer, Users, UserPlus, Download, Settings, Menu, X } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView }) => {
  ...
  const menuItems = [
    ...
    { id: AppView.CUSTOMERS, label: 'Customers', icon: UserPlus },
      ...
      `}>
        <div className="p-6 border-b border-slate-700 hidden lg:flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">POS & Business Hub</p>
          </div>
        </div>
